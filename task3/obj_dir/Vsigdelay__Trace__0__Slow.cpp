...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+13,"ADDR_WIDTH", false,-1, 31,0);
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"en", false,-1);
    tracep->declBit(c+3,"rst", false,-1);
    tracep->declBit(c+4,"wr", false,-1);
    ...
    tracep->declBus(c+7,"mic_signal", false,-1, 7,0);
    tracep->declBus(c+8,"delayed_signal", false,-1, 7,0);
    tracep->declBus(c+9,"addrr_wire", false,-1, 8,0);
    ...
    tracep->declBit(c+4,"wr", false,-1);
    tracep->declBit(c+5,"rd", false,-1);
    tracep->declBus(c+9,"addrr", false,-1, 8,0);
    tracep->declBus(c+10,"addrw", false,-1, 8,0);
    tracep->declBus(c+7,"din", false,-1, 7,0);
    tracep->declBus(c+8,"dout", false,-1, 7,0);
    tracep->declBus(c+11,"internal_offset_buffer", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+9,(vlSelf->sigdelay__DOT__addrr_wire),9);
    bufp->fullSData(oldp+10,(vlSelf->sigdelay__DOT____Vcellinp__myRam__addrw),9);
    bufp->fullSData(oldp+11,(vlSelf->sigdelay__DOT__myRam__DOT__internal_offset_buffer),9);

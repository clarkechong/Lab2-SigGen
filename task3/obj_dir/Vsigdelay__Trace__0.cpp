...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT__addrr_wire),9);
    bufp->chgSData(oldp+9,(vlSelf->sigdelay__DOT____Vcellinp__myRam__addrw),9);
    bufp->chgSData(oldp+10,(vlSelf->sigdelay__DOT__myRam__DOT__internal_offset_buffer),9);
}

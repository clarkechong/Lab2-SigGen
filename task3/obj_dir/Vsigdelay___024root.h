...
class Vsigdelay___024root final : public VerilatedModule {
  public:
    ...
    VL_IN16(offset,8,0);
    SData/*8:0*/ sigdelay__DOT__addrr_wire;
    SData/*8:0*/ sigdelay__DOT____Vcellinp__myRam__addrw;
    SData/*8:0*/ sigdelay__DOT__myRam__DOT__internal_offset_buffer;
    VlUnpacked<CData/*7:0*/, 512> sigdelay__DOT__myRam__DOT__rom_array;
